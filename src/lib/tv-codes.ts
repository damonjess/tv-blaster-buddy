...
export const BRANDS: Brand[] = [
  ...
  { name: 'Vizio', codes: [nec(0x20DF10EF), nec(0x4CB340BF)], shared: true },
  { name: 'Sharp', codes: [nec(0x41A2, 38000), nec(0x4122, 38000)] },
  { name: 'Toshiba', codes: [nec(0x02FD48B7), nec(0x45BC01FE)] },
  { name: 'TCL', codes: [nec(0x20DF10EF), nec(0x4CB340BF)], shared: true },
  { name: 'Hisense', codes: [nec(0x20DF10EF), nec(0xFB0408F7)], shared: true },
  { name: 'Digihome / Vestel', codes: [nec(0x00BF12ED), nec(0x04FB08F7)] },
  { name: 'Insignia', codes: [nec(0x02FD48B7)] },
  { name: 'Roku TV', codes: [nec(0x20DF10EF)], shared: true },
  // JVC uses its own 16-bit protocol, not NEC — now encoded with the jvc() helper.
  { name: 'JVC', codes: [jvc(0xC0E8)] },
  // Hitachi NEC frame written as an explicit 32-bit value (leading zero) for clarity.
  { name: 'Hitachi', codes: [nec(0x01FE48B7)] },
